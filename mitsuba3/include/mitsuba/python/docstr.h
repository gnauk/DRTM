...
static const char *__doc_mitsuba_IrregularDiscretDistribution =
R"doc(Continuous 1D probability distribution defined in terms of an
*irregularly* sampled linear interpolant
...
static const char *__doc_mitsuba_IrregularDiscretDistribution_IrregularDiscretDistribution = R"doc(Create an uninitialized IrregularContinuousDistribution instance)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_IrregularDiscretDistribution_2 =
R"doc(Initialize from a given density function discretized on nodes
``nodes``)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_IrregularDiscretDistribution_3 = R"doc(Initialize from a given density function (rvalue version))doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_IrregularDiscretDistribution_4 = R"doc(Initialize from a given floating point array)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_cdf =
R"doc(Return the unnormalized discrete cumulative distribution function over
intervals)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_cdf_2 =
R"doc(Return the unnormalized discrete cumulative distribution function over
intervals (const version))doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_compute_cdf = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_empty = R"doc(Is the distribution object empty/uninitialized?)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_eval_cdf =
R"doc(Evaluate the unnormalized cumulative distribution function (CDF) at
position ``p``)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_eval_cdf_normalized =
R"doc(Evaluate the unnormalized cumulative distribution function (CDF) at
position ``p``)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_eval_pdf =
R"doc(Evaluate the unnormalized probability mass function (PDF) at position
``x``)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_eval_pdf_normalized =
R"doc(Evaluate the normalized probability mass function (PDF) at position
``x``)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_integral = R"doc(Return the original integral of PDF entries before normalization)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_interval_resolution = R"doc(Return the minimum resolution of the discretization)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_cdf = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_integral = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_interval_size = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_max = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_nodes = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_normalization = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_pdf = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_range = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_m_valid = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_max = R"doc()doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_nodes = R"doc(Return the nodes of the underlying discretization)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_nodes_2 = R"doc(Return the nodes of the underlying discretization (const version))doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_normalization = R"doc(Return the normalization factor (i.e. the inverse of sum()))doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_pdf = R"doc(Return the unnormalized discretized probability density function)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_pdf_2 =
R"doc(Return the unnormalized discretized probability density function
(const version))doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_range = R"doc(Return the range of the distribution)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_range_2 = R"doc(Return the range of the distribution (const version))doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_sample =
R"doc(%Transform a uniformly distributed sample to the stored distribution
...
static const char *__doc_mitsuba_IrregularDiscretDistribution_sample_pdf =
R"doc(%Transform a uniformly distributed sample to the stored distribution
...
static const char *__doc_mitsuba_IrregularDiscretDistribution_size = R"doc(Return the number of discretizations)doc";

static const char *__doc_mitsuba_IrregularDiscretDistribution_update =
R"doc(Update the internal state. Must be invoked when changing the pdf or
range.)doc";
...
static const char *__doc_mitsuba_SurfaceInteraction_instance_index = R"doc(Instance index, e.g. the instance ID (if applicable))doc";
