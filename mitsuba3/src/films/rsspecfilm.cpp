...
class RSSpecFilm final : public Film<Float, Spectrum> {
public:
    ...
    RSSpecFilm(const Properties &props) : Base(props) {
...
MI_IMPLEMENT_CLASS_VARIANT(RSSpecFilm, Film)
MI_EXPORT_PLUGIN(RSSpecFilm, "RS Spectral Bands Film")
