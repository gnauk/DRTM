...
.. _emitter-constant:
 ...
 environment emitter (:monosp:`HemisphereEmitter`)
-------------------------------------------------
...
class HemisphereEmitter final : public Emitter<Float, Spectrum> {
public:
    MI_IMPORT_BASE(Emitter, m_flags)
    MI_IMPORT_TYPES(Scene, Shape, Texture)

    HemisphereEmitter(const Properties &props) : Base(props) {
        /* Until `set_scene` is called, we have no information
           about the scene and default to the unit bounding sphere. */
        m_bsphere = ScalarBoundingSphere3f(ScalarPoint3f(0.f), 1.f);
        m_surface_area = 2.f * dr::Pi<ScalarFloat>;
    ...
    void set_scene(const Scene *scene) override {
        ...
        m_surface_area = 2.f * dr::Pi<ScalarFloat> * dr::sqr(m_bsphere.radius);
    }
    ...
    std::pair<Ray3f, Spectrum> sample_ray(Float time, Float wavelength_sample,
        ...
        Vector3f v0 = warp::square_to_uniform_hemisphere_y(sample2);
    ...
    std::pair<DirectionSample3f, Spectrum> sample_direction(const Interaction3f &it,
        ...
        Vector3f d = warp::square_to_uniform_hemisphere_y(sample);
        ...
        ds.uv      = sample;
        ds.time    = it.time;
        ds.pdf     = warp::square_to_uniform_hemisphere_y_pdf(d);
        ds.delta   = false;
        ds.emitter = this;
        ds.d       = d;
        ds.dist    = dist;
    ...
    Float pdf_direction(const Interaction3f &, const DirectionSample3f &ds,
        ...
        return warp::square_to_uniform_hemisphere_y_pdf(ds.d);
    }
    ...
    std::string to_string() const override {
        ...
        oss << "HemisphereEmitter[" << std::endl
...
MI_IMPLEMENT_CLASS_VARIANT(HemisphereEmitter, Emitter)
MI_EXPORT_PLUGIN(HemisphereEmitter, "hemisphere emitter")
